...
export const CLI_SPECIAL: Record<string, string> = {
  ...
  'type-check:tools': 'Tools island typecheck (tools/tsconfig.json → tsconfig.bun.json)',
  'type-check:sto': 'sports-terminal-os typecheck (tsconfig.check.json, TS catalog 6.0.3)',
  'check:tsconfig-types': 'Audit tsconfig "types": ["bun"] allowlist (TS6+/TS7)',
  'docs:api-index': 'Emit tools/bun-api-index.json (CANONICAL_REFS pointer for agents)',
