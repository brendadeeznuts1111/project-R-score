...
class WikiMatrixCLI {
  ...
  private showHelp(): void {
    ...
    console.log(styled('  bun run scripts/wiki-matrix-cli-improved.ts', 'muted'));
    console.log(styled('  bun run scripts/wiki-matrix-cli-improved.ts details 2', 'muted'));
    console.log(styled('  bun run scripts/wiki-matrix-cli-improved.ts compare', 'muted'));
    console.log(styled('  bun run scripts/wiki-matrix-cli-improved.ts interactive', 'muted'));
    console.log('');
