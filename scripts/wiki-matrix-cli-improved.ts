...
class WikiMatrixCLI {
  ...
  private showHelp(): void {
    ...
    console.info(styled('  bun run scripts/wiki-matrix-cli-improved.ts', 'muted'));
    console.info(styled('  bun run scripts/wiki-matrix-cli-improved.ts details 2', 'muted'));
    console.info(styled('  bun run scripts/wiki-matrix-cli-improved.ts compare', 'muted'));
    console.info(styled('  bun run scripts/wiki-matrix-cli-improved.ts interactive', 'muted'));
    console.info('');
