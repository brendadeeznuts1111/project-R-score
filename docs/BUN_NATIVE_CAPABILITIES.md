...
| [`Bun.markdown.ansi`](https://bun.com/docs/runtime/markdown) | Adopted | [`lib/console-depth.ts`](../lib/console-depth.ts)<br>[`lib/factory/markdown.ts`](../lib/factory/markdown.ts)<br>[`scripts/dx-mcp.ts`](../scripts/dx-mcp.ts)<br>[`tools/bun-api-oneliners.ts`](../tools/bun-api-oneliners.ts)<br>[`tools/bun-api-showcase/oneliners.ts`](../tools/bun-api-showcase/oneliners.ts) | [`bun-markdown-ansi`](../.agents/skills/ast-grep/bun-patterns.json) |
