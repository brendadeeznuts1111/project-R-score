...
| `Bun.Image` | decode / resize / encode · `metadata()` for evidence (dims, format, size, sha256) · TEST-003 remediation | helpers [`lib/image-metadata.ts`](../lib/image-metadata.ts) · [`lib/screenshot-remediation.ts`](../lib/screenshot-remediation.ts) · `bun test tests/image-metadata.test.ts` · [input](https://bun.com/docs/runtime/image#input) · [metadata](https://bun.com/docs/runtime/image#metadata) · ship [1.3.14](https://bun.com/blog/bun-v1.3.14) |
