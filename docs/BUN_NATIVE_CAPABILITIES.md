...
| Bake spawn | `bake:all` + portal-cli nested bun → `bunSpawnArgs` / `resolveBunExecutable()` + `{ ...Bun.env }` | [`tools/bake-all.ts`](../tools/bake-all.ts) · [`portal-cli-bun-flags`](../tools/lib/portal-cli-bun-flags.ts) · [`portal-cli`](../tools/portal-cli.ts) cron · [`portal-cli-scanner`](../tools/lib/portal-cli-scanner.ts) · [`portal-probe`](../tools/portal-probe.ts) |
