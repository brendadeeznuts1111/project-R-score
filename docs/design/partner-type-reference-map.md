...
| bookmakers registry               | implemented pure account resolver + planned registry I/O adapter | canonical `SportsbookId`, exact/explicit-alias host resolution, skin and brand metadata                                                   | partner account status or inferred parent-domain matches                                  |
