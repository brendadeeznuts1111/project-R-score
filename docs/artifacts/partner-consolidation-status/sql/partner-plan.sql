...
SELECT 'Planned' AS status, 2 AS count, 'Connector contract exists; its source adapter is not implemented' AS meaning
UNION ALL SELECT 'Partial', 4, 'Observation parser is implemented; loading, resilience, or reconciliation remains'
...
UNION ALL SELECT 5, 'bookmakers-registry', 'trading', 'partial', 'Loader, resilience, and explicit host aliases'
