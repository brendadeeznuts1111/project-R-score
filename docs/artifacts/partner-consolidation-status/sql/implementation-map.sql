...
UNION ALL SELECT 3, 'Boundary', 'Resolve the Sports Terminal integration contract', 'blocked', 'Sports Terminal owner', 'One parsed input, external-ID resolver, authenticated route, and integer-money wire are selected'
