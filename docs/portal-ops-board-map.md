...
| `ssotFlowSoft` | [`/registry/ssot-flow-soft.json`](/registry/ssot-flow-soft.json) |
| `pmProof` | [`/registry/pm-proof.json`](/registry/pm-proof.json) |
...
### Group A: Registry / R2 (9)

| Short id | Label | Command | Flags | Docs |
|----------|-------|---------|-------|------|
| `ssot-flow-soft` | SSOT soft-pass (offline pack) | `bun run ssot:flow:soft` | — | [`/docs/harness/tenants/tennis-hq-registry.md`](../docs/harness/tenants/tennis-hq-registry.md) |
| `verify-pm-save` | PM publish-plane soft-pass save | `bun run verify:pm:save` | — | [`/docs/harness/tenants/tennis-hq-registry.md`](../docs/harness/tenants/tennis-hq-registry.md) |
| `verify-weave` | Pages edge weave verify | `bun run verify:weave -- --summary` | -- --summary | [`/docs/harness/tenants/cloudflare-pages.md`](../docs/harness/tenants/cloudflare-pages.md) |
| `script-3-tennis-hq-ssot-r2` | Tennis HQ SSOT → R2 | `bun run --cwd king-zippy-umbra-acre ssot:publish:r2` | --cwd | [`/docs/harness/tenants/tennis-hq-registry.md`](../docs/harness/tenants/tennis-hq-registry.md) |
| `script-4-factory-r2-health` | Factory R2 health | `bun run factory:health` | — | [`/docs/guides/REGISTRY_PRODUCTION_READINESS.md`](../docs/guides/REGISTRY_PRODUCTION_READINESS.md) |
| `script-5-factory-r2-list-packages` | Factory R2 list packages | `bun run factory:list` | — | [`/docs/registry-client.md`](../docs/registry-client.md) |
| `script-6-sync-r2-registry-index` | Sync R2 registry index | `bun run registry:sync-index-r2` | — | — |
| `script-7-pages-edge-verify` | Pages edge verify | `bun run verify:pages-edge --taxonomy` | --taxonomy | — |
| `script-8-domain-glossary-bake` | Domain glossary bake | `bun run glossary:portal` | — | [`/docs/portal-foundation.md`](../docs/portal-foundation.md) |

### Group B: Ops (17)

| Short id | Label | Command | Flags | Docs |
|----------|-------|---------|-------|------|
| `script-9-ops-snapshot-includes-compliance` | Ops snapshot (includes compliance) | `bun run ops:snapshot` | — | [`/docs/harness/tenants/ops-snapshot.md`](../docs/harness/tenants/ops-snapshot.md) |
| `script-10-demo-snapshot` | Demo snapshot | `bun run ops:snapshot:demo` | — | [`/docs/harness/tenants/ops-snapshot.md`](../docs/harness/tenants/ops-snapshot.md) |
| `script-11-prediction-seed` | Prediction seed | `bun run ops:seed:prediction` | — | — |
| `script-12-toc-ops-seed` | TOC Ops seed | `bun run ops:seed:toc` | — | [`/docs/harness/tenants/toc-ops.md`](../docs/harness/tenants/toc-ops.md) |
| `script-13-telegram-handshake-gap` | Telegram handshake gap | `bun run telegram:handshake:invite-gap` | — | [`/docs/harness/tenants/partner-package-group-handshake.md`](../docs/harness/tenants/partner-package-group-handshake.md) |
| `script-14-seat-capital-desk-refresh` | Seat capital desk refresh | `bun run seat:desk:refresh` | — | [`/docs/harness/tenants/seat-capital-desk.md`](../docs/harness/tenants/seat-capital-desk.md) |
| `script-15-partners-ops-registry-bake` | Partners-ops registry bake | `bun run partners:build` | — | [`/docs/harness/tenants/seat-capital-desk.md`](../docs/harness/tenants/seat-capital-desk.md) |
| `script-16-compliance-board-bake` | Compliance board bake | `bun run compliance:bake` | — | [`/docs/harness/tenants/compliance-portal.md`](../docs/harness/tenants/compliance-portal.md) |
| `script-17-compliance-verify-bake-tests` | Compliance verify (bake + tests) | `bun run compliance:verify` | — | [`/docs/harness/tenants/compliance-portal.md`](../docs/harness/tenants/compliance-portal.md) |
| `script-18-limit-raises-multi-factor-demo` | Limit raises multi-factor demo | `bun run ops:limits:demo` | — | [`/docs/harness/tenants/partner-limits.md`](../docs/harness/tenants/partner-limits.md) |
| `script-19-capture-raise-context` | Capture raise context | `bun run ops:limits:capture` | — | [`/docs/harness/tenants/partner-limits.md`](../docs/harness/tenants/partner-limits.md) |
| `script-20-limit-raise-predict` | Limit raise predict | `bun run ops:limits:predict` | — | [`/docs/harness/tenants/partner-limits.md`](../docs/harness/tenants/partner-limits.md) |
| `script-21-limit-raises-multi-check` | Limit raises multi check | `bun run ops:limits:check:multi` | — | [`/docs/harness/tenants/partner-limits.md`](../docs/harness/tenants/partner-limits.md) |
| `script-22-limit-raise-analyze` | Limit raise analyze | `bun run ops:limits:analyze` | — | [`/docs/harness/tenants/partner-limits.md`](../docs/harness/tenants/partner-limits.md) |
| `script-23-limit-pattern-seed-bake` | Limit pattern seed + bake | `bun run ops:limits:seed-patterns` | — | [`/docs/harness/tenants/partner-limits.md`](../docs/harness/tenants/partner-limits.md) |
...
| Short id | Label | Command | Flags | Docs |
|----------|-------|---------|-------|------|
| `script-26-portal-doctor-all-groups` | Portal doctor (all groups) | `bun run portal:doctor --verbose` | --verbose | [`/docs/harness/tenants/portal-doctor.md`](../docs/harness/tenants/portal-doctor.md) |
| `script-27-portal-doctor-bunfig-only` | Portal doctor (bunfig only) | `bun run portal:doctor --group bunfig --verbose` | --group --verbose | [`/docs/UNIFIED.md`](../docs/UNIFIED.md) |
| `script-28-bake-doctor-state` | Bake doctor-state | `bun run bake:doctor` | — | [`/docs/harness/tenants/portal-doctor.md`](../docs/harness/tenants/portal-doctor.md) |
| `script-29-reference-discovery` | Reference discovery | `bun run reference:discover:check` | — | [`/docs/harness/tenants/reference-discovery.md`](../docs/harness/tenants/reference-discovery.md) |
| `script-30-public-plane-discovery` | Public plane discovery | `bun run public:discover:check` | — | [`/docs/harness/tenants/public-plane.md`](../docs/harness/tenants/public-plane.md) |
| `script-31-public-audit-bundle` | Public audit bundle | `bun run public:audit:verify` | — | [`/docs/harness/tenants/public-plane.md`](../docs/harness/tenants/public-plane.md) |
| `script-32-discovery-compose` | Discovery compose | `bun run discover:compose:check` | — | [`/docs/harness/tenants/reference-discovery.md`](../docs/harness/tenants/reference-discovery.md) |
| `script-33-doc-map-check` | Doc map check | `bun run docs:map:check` | — | [`/docs/README.md`](../docs/README.md) |
...
| `packages` | [`/portal/packages/`](/portal/packages/) | `bun run ssot:flow:soft && bun run verify:pm:save` | Portal board |
