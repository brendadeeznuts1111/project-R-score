...
| `BUN_STRIP_UNKNOWN` / CLI allowlists | root [AGENTS.md § Unknown long options](../AGENTS.md#unknown-long-options-bun_strip_unknown) · [`ref-id-tool-flags.ts`](../lib/docs/ref-id-tool-flags.ts) · [cli-constants-flags](./harness/cli-constants-flags.md) · `bun run cli:flags:check` · `bun test tests/docs-ref-id-tool-exports.test.ts` |
| Bun PR verify (`bunx bun-pr`) | `bun run bun:pr:fetch -- <pr>` · `bun run bun:pr:verify -- <pr> [--proof=all] [--json]` · [`tools/bun-pr-verify.ts`](../tools/bun-pr-verify.ts) · [bun-upstream-contributing](./harness/tenants/bun-upstream-contributing.md) · allowlist leaves `proof` · `json` |
