...
| Console depth / `bun run -` / `cliOut` | root [AGENTS.md § Console depth](../AGENTS.md#console-depth-output-verbosity) · domain [`lib/console/`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/lib/console/README.md) · note [`lib/console-depth.md`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/lib/console-depth.md) · hub [`lib/bun-runtime.md`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/lib/bun-runtime.md) · `bun test tests/console-depth.test.ts tests/console-lib.test.ts` |
| `bun create` / factory scaffold | root [AGENTS.md § bun create](../AGENTS.md#bun-create-templating--scaffold) · [templating/create](https://bun.com/docs/runtime/templating/create) · [`lib/factory/README.md`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/lib/factory/README.md) · `.bun-create/` · `bun run factory:create` · env [`BUN_GITHUB_ENV`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/lib/github-repository-ref.ts) |
| `BUN_STRIP_UNKNOWN` / CLI allowlists | root [AGENTS.md § Unknown long options](../AGENTS.md#unknown-long-options-bun_strip_unknown) · [`ref-id-tool-flags.ts`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/lib/docs/ref-id-tool-flags.ts) · [cli-constants-flags](./harness/cli-constants-flags.md) · `bun run cli:flags:check` · `bun test tests/docs-ref-id-tool-exports.test.ts` |
| Bun PR verify (`bunx bun-pr`) | `bun run bun:pr:fetch -- <pr>` · `bun run bun:pr:verify -- <pr> [--proof=all] [--json]` · [`tools/bun-pr-verify.ts`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/tools/bun-pr-verify.ts) · [bun-upstream-contributing](./harness/tenants/bun-upstream-contributing.md) · allowlist leaves `proof` · `json` |
