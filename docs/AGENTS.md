...
| `BUN_STRIP_UNKNOWN` / CLI allowlists | root [AGENTS.md § Unknown long options](../AGENTS.md#unknown-long-options-bun_strip_unknown) · [`ref-id-tool-flags.ts`](../lib/docs/ref-id-tool-flags.ts) · [CONTRIBUTING](./contributing/CONTRIBUTING.md#unknown-long-option-allowlists-cli-guards) · `bun test tests/docs-ref-id-tool-exports.test.ts` |
