...
- Packages graph map + env inventory → `bun run audit:packages:env` / `env:inventory:bake` · `/portal/packages/` · `/portal/env/` · [`tenants/monorepo-health.md`](tenants/monorepo-health.md) · [`tenants/proton-integration.md`](tenants/proton-integration.md) · claim `packages-graph-map-v11`
