...
- Agent skill definitions / loop registry alignment → `bun run skills:validate` · Project R ↔ global DX/installed-copy contract → `bun run dx:contract:check` then machine `dx setup` · [`.agents/skills/project-r-skill-maintenance/SKILL.md`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/.agents/skills/project-r-skill-maintenance/SKILL.md) · [`config/project-r-dx-contract.json`](https://github.com/brendadeeznuts1111/project-R-score/blob/main/config/project-r-dx-contract.json)
