...
- Partner package group handshake (factory ↔ ct) → [`tenants/partner-package-group-handshake.md`](tenants/partner-package-group-handshake.md) · `bun tools/onboard-partner-package.ts ASH-001 --create-package-group` · `bun run telegram:handshake:verify ASH` · `bun run telegram:ops -- link-package-group ASH -100…`
