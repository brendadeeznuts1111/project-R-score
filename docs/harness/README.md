...
- Portal doctor (bunfig · catalog · linker) → `bun run portal:doctor` · `bake:doctor` · `/portal/doctor/` · [`tenants/portal-doctor.md`](tenants/portal-doctor.md) · policy [`docs/UNIFIED.md`](../UNIFIED.md)
