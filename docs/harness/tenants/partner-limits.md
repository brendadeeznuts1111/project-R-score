...
| **CLI — account dossier seed** | [`tools/seed-account-dossier.ts`](../../../tools/seed-account-dossier.ts) · [`lib/operations/account-dossier-seed.ts`](../../../lib/operations/account-dossier-seed.ts)                                                                            | Full dossier demo: TOC bridge + NJ geo/license + profiles + **168h** bake · `--force` for identity/limit rewrite · optional test DB  |
