...
| Chrome nav | `bookmakers` (overflow, ops) — chrome **Domain** `partner` is nav-only; entity is bookmaker, not partner ([`lib/portal/chrome-catalog.ts`](../../../lib/portal/chrome-catalog.ts)) |
