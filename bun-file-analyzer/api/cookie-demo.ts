// Bun Cookie API Demonstration
// Shows official Bun cookie handling as per https://bun.com/docs/runtime/http/cookies
...
const server = Bun.serve({
  ...
  fetch(req) {
    ...
    if (path === "/profile") {
      // Access cookies from the request using Bun's official API
    ...
    if (path === "/logout") {
      // Delete the user_id cookie using Bun's official API
