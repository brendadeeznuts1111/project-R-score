...
# Bun native API (bun-patterns.json v3 — bundles, score, cache)
python3 $AG bun bundles                             # server-boot, cli, core, hygiene
python3 $AG bun patterns --bundle server-boot       # curated API subset
