...
Real-time trading intelligence terminal at `projects/active/enterprise/cascade-mover-v3/` (gitignored, own repo). **Prefer MCP tools** over reading this skill — the `cascade-mover` server exposes 43 tools for lines, sources, confidence, and dashboard state.
...
- Bun.sqlite / WebSocket dashboard work inside `projects/active/enterprise/cascade-mover-v3/`
...
`projects/active/enterprise/cascade-mover-v3/src/server/cascade-mover-mcp.ts` — MCP entry. See project README for full architecture.
