...
describe('pre-commit path gates', () => {
  ...
  it('selects skill validation paths', () => {
    ...
    expect(isSkillValidationPath('scripts/check-project-r-agent-contract.ts')).toBe(true);
    expect(isSkillValidationPath('config/project-r-agent-contract.json')).toBe(true);
