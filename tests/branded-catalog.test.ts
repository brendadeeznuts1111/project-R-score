...
describe('branded domain-value catalog', () => {
  test('catalog is a unique 94-value, 10-domain contract', () => {
    expect(branded.BRAND_CATALOG).toHaveLength(94);
    ...
    expect(kinds.filter(kind => kind === 'id')).toHaveLength(72);
  ...
  test('generated guards cover every canonical runtime shape', () => {
    expect(Object.keys(branded.BRAND_GUARDS)).toHaveLength(94);
