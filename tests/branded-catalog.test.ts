...
describe('branded domain-value catalog', () => {
  test('catalog is a unique 93-value, 10-domain contract', () => {
    expect(branded.BRAND_CATALOG).toHaveLength(93);
    ...
    expect(kinds.filter(kind => kind === 'id')).toHaveLength(71);
  ...
  test('generated guards cover every canonical runtime shape', () => {
    expect(Object.keys(branded.BRAND_GUARDS)).toHaveLength(93);
