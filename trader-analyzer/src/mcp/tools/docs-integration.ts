			...
			execute: async (args: Record<string, any>) => {
				try {
					...
					const bunDocs: Record<string, string> = {
						...
						"Bun.secrets": BUN_DOCS_URLS.SECRETS,
						"Bun.nanoseconds": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.sleep": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.write": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.read": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.hash": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.randomUUIDv5": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.generateHeapSnapshot": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.ffi": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.Worker": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.Glob": BUN_DOCS_URLS.RUNTIME_APIS,
						"Bun.inspect": BUN_DOCS_URLS.RUNTIME_APIS,
						URLSearchParams: BUN_DOCS_URLS.GLOBALS_REFERENCE + "/URLSearchParams",
					};
					...
					if (api) {
						...
						if (url) {
							return {
								content: [
									{
										text: `Bun API: ${api}\nDocumentation: ${url}\n\nFull Bun Reference: ${BUN_DOCS_URLS.API_REFERENCE}\nBun Globals: ${BUN_DOCS_URLS.GLOBALS_REFERENCE}`,
									},
								],
							};
						}
						...
						content: [
							{
								text:
									...
									`Documentation:\n` +
									`  Bun Reference: ${BUN_DOCS_URLS.API_REFERENCE}\n` +
