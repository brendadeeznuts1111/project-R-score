...
async function main() {
	console.info("🔬 Nanosecond Precision Progress Demo");
	console.info("=====================================");
	...
	console.info(`⏱️  Elapsed: ${progress.elapsedMs.toFixed(2)}ms`);
	...
	console.info(`   Operations: ${summary.operations}`);
	console.info(`   Elapsed: ${summary.elapsedMs.toFixed(2)}ms`);
	console.info(`   Rate: ${summary.opsPerSecond.toFixed(0)} ops/sec`);
	...
	console.info(`📈 Batch Performance:`);
	console.info(`   Items processed: ${batchSummary.operations}`);
	console.info(`   Total time: ${batchSummary.elapsedMs.toFixed(2)}ms`);
	console.info(
	...
	console.info("Comparing Date.now() vs Bun.nanoseconds():");
	...
	console.info(`📊 Precision Comparison (${iterations} iterations):`);
	console.info(`   Date.now():     ${dateElapsed.toFixed(2)}ms`);
	console.info(`   Bun.nanoseconds(): ${bunElapsed.toFixed(4)}ms`);
	console.info(
	...
	console.info("=====================================");
	console.info("✅ Enhanced ProgressIndicator with Bun.nanoseconds()");
	console.info("✅ PerformanceMonitor for high-precision metrics");
	console.info("✅ Improved ETA and rate calculations");
	console.info("✅ Better timing accuracy for CLI operations");
}
