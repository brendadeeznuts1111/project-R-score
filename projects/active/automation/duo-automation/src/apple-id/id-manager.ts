 ...
 * - Serial numbers (FactoryWager format)
 */
...
export class IdentityManager {
  ...
  constructor(config: Partial<IdentityConfig> = {}) {
    this.config = {
      emailDomain: 'factory-wager-registry.utahj4754.workers.dev',
      r2Bucket: 'bunx-vault',
      version: '2.0.0',
      provider: 'factory-wager',
      ...config
    };
  }
   ...
   * Example: master+pqsq4lyrst34@factory-wager-registry.utahj4754.workers.dev
   */
