...
export class DisputeSystem {
    ...
    return [
      {
        ...
        timeline: '0-2 hours',
        deepLink: 'factory-wager://dispute/DSP-12345/submitted'
      },
      {
        ...
        timeline: '2-48 hours',
        deepLink: 'factory-wager://dispute/DSP-12345/merchant-review'
      },
      {
        ...
        timeline: '1-5 days',
        deepLink: 'factory-wager://dispute/DSP-12345/investigation'
      },
      {
        ...
        timeline: '5-10 days',
        deepLink: 'factory-wager://dispute/DSP-12345/venmo-case/V987654'
      },
      {
        ...
        timeline: 'Instant',
        deepLink: 'factory-wager://dispute/DSP-12345/resolved/refund'
      },
      {
        ...
        timeline: 'Instant',
        deepLink: 'factory-wager://dispute/DSP-12345/resolved/denied'
      },
      {
        ...
        timeline: '14-30 days',
        deepLink: 'factory-wager://dispute/DSP-12345/suspected-fraud'
      }
    ];
  }
  ...
  private generateSMSLink(dispute: Dispute): string {
    ...
    const message = `FactoryWager Dispute ${dispute.id}: ${deepLink}`;
  ...
  private generateEmailLink(dispute: Dispute): string {
    ...
    const subject = `FactoryWager Dispute: ${dispute.id}`;
  ...
  private generateSMSTemplate(dispute: Dispute, deepLink: string): string {
    return `
FactoryWager Dispute Update: ${dispute.id}
...
<html>
<body>
  <h2>FactoryWager Dispute Update</h2>
  ...
  <p style="color: #666; font-size: 12px;">
    This is an automated message about your FactoryWager dispute.
    Need help? Contact support at support@factory-wager.com
  </p>
</body>
</html>
    `.trim();
  ...
  private generateWhatsAppTemplate(dispute: Dispute, deepLink: string): string {
    return `
FactoryWager Dispute ${dispute.id}
