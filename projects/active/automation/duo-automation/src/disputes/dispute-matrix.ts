...
export class DisputeMatrix {
    ...
    return [
      {
        ...
        timeline: '0-2 hours',
        deepLink: `factory-wager://dispute/${disputeId}/submitted`,
        nextSteps: [
      ...
      },
      {
        ...
        timeline: '2-48 hours',
        deepLink: `factory-wager://dispute/${disputeId}/merchant-review`,
        nextSteps: [
      ...
      },
      {
        ...
        icon: '🔵',
        color: '#4444FF',
        description: 'FactoryWager team is investigating with AI assistance',
        customerActions: [
        ...
        timeline: '1-5 days',
        deepLink: `factory-wager://dispute/${disputeId}/investigation`,
        nextSteps: [
      ...
      },
      {
        ...
        timeline: '5-10 days',
        deepLink: `factory-wager://dispute/${disputeId}/venmo-case`,
        nextSteps: [
      ...
      },
      {
        ...
        timeline: 'Instant',
        deepLink: `factory-wager://dispute/${disputeId}/resolved/refund`,
        nextSteps: [
          'Refund processed',
          'Case closed',
          'Feedback collected'
      ...
      },
      {
        ...
        timeline: 'Instant',
        deepLink: `factory-wager://dispute/${disputeId}/resolved/denied`,
        nextSteps: [
          'Case closed',
          'Funds released',
          'Records updated'
      ...
      },
      {
        ...
        timeline: '14-30 days',
        deepLink: `factory-wager://dispute/${disputeId}/suspected-fraud`,
        nextSteps: [
    ...
    const baseActions: DisputeAction[] = [
      {
        ...
        deepLink: `factory-wager://dispute/${dispute.id}/upload-evidence`,
        icon: '📎',
        requiresAuth: true,
        priority: 'high'
      },
      {
        ...
        deepLink: `factory-wager://dispute/${dispute.id}/chat`,
        icon: '💬',
        requiresAuth: true,
        priority: 'medium'
      },
      {
        ...
        deepLink: `factory-wager://dispute/${dispute.id}/details`,
        icon: '📋',
        requiresAuth: true,
        priority: 'low'
      },
      {
        ...
        deepLink: `factory-wager://dispute/${dispute.id}/report`,
        icon: '📄',
        requiresAuth: true,
        priority: 'low'
      }
    ...
    switch (dispute.status) {
      case DisputeStatus.SUBMITTED:
        baseActions.unshift({
          ...
          deepLink: `factory-wager://dispute/${dispute.id}/escalate`,
          icon: '⚠️',
          requiresAuth: true,
          priority: 'medium'
        });
      ...
      case DisputeStatus.MERCHANT_REVIEW:
        baseActions.unshift({
          ...
          deepLink: `factory-wager://dispute/${dispute.id}/add-evidence`,
          icon: '📸',
          requiresAuth: true,
          priority: 'high'
        });
      ...
      case DisputeStatus.UNDER_INVESTIGATION:
        baseActions.unshift({
          ...
          deepLink: `factory-wager://dispute/${dispute.id}/status`,
          icon: '🔍',
          requiresAuth: true,
          priority: 'medium'
        });
      ...
      case DisputeStatus.VENMO_ESCALATION:
        baseActions.unshift({
          ...
          deepLink: `factory-wager://dispute/${dispute.id}/venmo-status`,
          icon: '⚖️',
          requiresAuth: true,
          priority: 'high'
        });
      ...
      case DisputeStatus.RESOLVED_DENIED:
        baseActions.unshift({
          ...
          deepLink: `factory-wager://dispute/${dispute.id}/appeal`,
          icon: '📤',
          requiresAuth: true,
          priority: 'high'
        });
  ...
  static generateStatusEmail(dispute: Dispute, recipient: 'customer' | 'merchant'): string {
    ...
    return `
      ...
      <p><a href="${row.deepLink}">View in FactoryWager App</a></p>
    `;
  }
