...
server.listen(PORT, () => {
  console.info('🏭 Factory-Wager Admin Dashboard running successfully!');
  console.info('='.repeat(60));
  console.info('🌐 Local URL: http://localhost:3000');
  console.info('🏭 Production URL: https://admin.factory-wager.com');
  console.info('');
  ...
  console.info('  ✅ Log monitoring and analysis');
  console.info('  ✅ Administrative controls');
  console.info('');
  console.info('🔧 API Endpoints:');
  console.info('  GET  /                    - Dashboard HTML');
  ...
  console.info('  GET  /api/metrics         - Performance metrics');
  console.info('  GET  /health              - Health check');
  console.info('');
  console.info('🎯 Ready for domain-level operations!');
});
