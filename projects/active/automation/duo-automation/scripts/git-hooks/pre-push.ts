...
console.info(`🛡️ EnterpriseCoverageEnforcer: Validating coverage (Threshold: ${THRESHOLD}%)...`);
...
console.info(`✅ Coverage threshold of ${THRESHOLD}% met. Escalating to remote.`);
process.exit(0);