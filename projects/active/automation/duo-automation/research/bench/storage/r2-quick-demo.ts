...
async function quickDemo() {
  ...
  console.info('Upload:', result.success ? '✅' : '❌');
  ...
  if (result.success) {
    ...
    console.info('Download:', parsed.test === 'R2 integration' ? '✅' : '❌');
    console.info('Compression:', result.savings.toFixed(1) + '%');
    console.info('URL:', `https://pub-dc0e1ef5dd2245be81d6670a9b7b1550.r2.dev/${result.key}`);
  }
}
