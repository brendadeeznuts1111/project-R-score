...
async function showcaseR2Integration() {
  ...
  console.info(`  📦 Bucket: ${Bun.env.R2_BUCKET || 'factory-wager-packages'}`);
  console.info(`  🔗 Endpoint: ${Bun.env.S3_ENDPOINT || 'Cloudflare R2'}`);
  console.info(`  🌐 Public URL: https://pub-dc0e1ef5dd2245be81d6670a9b7b1550.r2.dev`);
  ...
  try {
    ...
    if (uploadResult.success) {
      ...
      console.info(`  🔗 Public URL: https://pub-dc0e1ef5dd2245be81d6670a9b7b1550.r2.dev/${uploadResult.key}`);
    }
  } catch (error: any) {
