...
console.info("# 🔒 Enterprise Security Policy Configuration");
console.info("# CONFIG.BUNFIG.SECURITY - Active policy settings");
console.info("# Generated by bun run security:policy");
console.info("");
