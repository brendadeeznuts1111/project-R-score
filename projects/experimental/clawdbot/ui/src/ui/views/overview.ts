    ...
    <section class="grid grid-cols-2">
      <div class="card">
        ...
        <div class="row" style="margin-top: 14px;">
          ...
          <button class="btn" @click=${() => props.onShowQrCode()}>QR Code</button>
      ...
      ${props.qrCodeDataUrl
        ? html`
            <div class="qr-modal-overlay" @click=${() => props.onCloseQrCode()}>
              <div class="qr-modal" @click=${(e: Event) => e.stopPropagation()}>
                <div class="qr-modal-header">
                  <span>Scan to connect</span>
                  <button class="qr-close-btn" @click=${() => props.onCloseQrCode()}>&times;</button>
                </div>
                <img src=${props.qrCodeDataUrl} alt="QR Code" class="qr-image" />
