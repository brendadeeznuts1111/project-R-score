...
// Pre-compiled default patterns for hot path
const CACHED_DEFAULT_PATTERNS = resolvePatterns();
...
export function redactSensitiveText(text: string, options?: RedactOptions): string {
  ...
  // Use cached patterns when using defaults (hot path optimization)
  const patterns = resolved.patterns?.length
    ? resolvePatterns(resolved.patterns)
    : CACHED_DEFAULT_PATTERNS;
