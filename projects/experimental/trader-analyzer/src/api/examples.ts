...
export const apiExamples: APIExample[] = [
	{
		...
		api: "Bun.CookieMap",
		docsUrl: BUN_DOCS_URLS.API_REFERENCE,
...
const headers = cookies.toSetCookieHeaders();`,
	...
	},
	{
		...
		api: "URLSearchParams",
		docsUrl: BUN_DOCS_URLS.GLOBALS_REFERENCE + "/URLSearchParams",
...
c d true`,
	...
	},
	{
		...
		api: "Bun.serve",
		docsUrl: `${BUN_DOCS_URLS.DOCS}/runtime/bun-apis`,
		code: `// HTTP server
...
// - URLSearchParams (global) - BUN_DOCS_URLS.API_REFERENCE/globals/URLSearchParams
// - URL (global) - BUN_DOCS_URLS.API_REFERENCE/globals/URL
// - fetch (global) - Bun native fetch API
// - Database (bun:sqlite) - BUN_DOCS_URLS.API_REFERENCE
//
...
export class UrlAnomalyDetector {
   ...
   * @see Bun API: URLSearchParams - BUN_DOCS_URLS.API_REFERENCE/globals/URLSearchParams
   */
  async testBookmakerEncoding(bookmaker: string): Promise<{
    ...
    // Bun native fetch() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
   ...
   * @see Bun API: Database (bun:sqlite) - BUN_DOCS_URLS.API_REFERENCE
   * 
...
c d true`,
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Database.run() - BUN_DOCS_URLS.API_REFERENCE
// - Database.query() - BUN_DOCS_URLS.API_REFERENCE
...
// - URLSearchParams (global) - BUN_DOCS_URLS.API_REFERENCE/globals/URLSearchParams
// - URL (global) - BUN_DOCS_URLS.API_REFERENCE/globals/URL
// - Database.run() (bun:sqlite) - BUN_DOCS_URLS.API_REFERENCE
...
export class MaliciousQueryDetector {
   ...
   * @see Bun API: URL - BUN_DOCS_URLS.API_REFERENCE/globals/URL
   * @see Bun API: URLSearchParams - BUN_DOCS_URLS.API_REFERENCE/globals/URLSearchParams
   */
   ...
   * @see Bun API: Database.run() - BUN_DOCS_URLS.API_REFERENCE
   */
  async validateBookmakerRequest(
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Bun.randomUUIDv7() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - URLSearchParams (global) - BUN_DOCS_URLS.API_REFERENCE/globals/URLSearchParams
// - URL (global) - BUN_DOCS_URLS.API_REFERENCE/globals/URL
...
// 4. Actions: quarantine request, alert trader, log security event`,
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Bun.shell ($) - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.file() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 ...
 * @see Bun API: Bun.shell - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
// - Bun.shell ($) - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.file() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.spawn() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
...
export class NativeLogViewer {
   ...
   * @see Bun API: Bun.spawn() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
   */
...
for await (const log of viewer.streamLogs('logs/app.log')) {
  console.log(\`[\${log.level}] \${log.message}\`);
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Bun.file() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.write() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
...
export class TelegramLogger {
   ...
   * @see Bun API: Bun.file() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
   * @see Bun API: Bun.write() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
   */
  async log(message: {
    timestamp: number;
    threadId?: number;
...
const threadHistory = await logger.getThreadHistory(12345);`,
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Bun.nanoseconds() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Date.now() - JavaScript native
 ...
 * @see Bun API: Bun.nanoseconds() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
// Uses seed from command line for test reproducibility`,
	...
	},
	{
		...
		functionRef: "execute",
		code: `// Bun Native APIs Used:
// - Bun.nanoseconds() - BUN_DOCS_URLS.DOCS/runtime/bun-apis (used internally by mitata)
...
console.log(results);`,
	...
	},
	{
		...
		api: "Bun.serve",
		docsUrl: `${BUN_DOCS_URLS.DOCS}/api/http-server`,
		filePath: "src/index.ts",
		classRef: "Bun.serve",
		functionRef: "server",
		code: `// Bun Native APIs Used:
// - Bun.serve<T>() - BUN_DOCS_URLS.DOCS/api/http-server
 ...
 * 
 * @see Bun API: Bun.serve() - BUN_DOCS_URLS.DOCS/api/http-server
...
console.log(\`Server running on port \${server.port}\`);`,
	...
	},
	{
		...
		functionRef: "build",
		code: `// Bun Native APIs Used:
// - Bun.build() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.file() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
//
 ...
 * 
 * @see Bun API: Bun.build() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 * @see Bun Latest Breaking Changes - docs/BUN-LATEST-BREAKING-CHANGES.md
 * 
...
const buildResult = await buildProduction();`,
	...
	},
	{
		...
		functionRef: "hash",
		code: `// Bun Native APIs Used:
// - Bun.hash() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.CryptoHasher - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.file() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
//
 ...
 * @see Bun API: Bun.hash() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
 ...
 * @see Bun API: Bun.CryptoHasher - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
const fileHash = await hashFile('./data/trades.json'); // file hash`,
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Bun.randomUUIDv7() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.randomUUIDv5() - BUN_DOCS_URLS.DOCS/runtime/bun-apis (deterministic)
//
 ...
 * @see Bun API: Bun.randomUUIDv7() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
 ...
 * @see Bun API: Bun.randomUUIDv5() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
console.log(\`Trade ID: \${tradeId}\`);`,
	...
	},
	{
		...
		functionRef: "sleep",
		code: `// Bun Native APIs Used:
// - Bun.sleep() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.sleepSync() - BUN_DOCS_URLS.DOCS/runtime/bun-apis (synchronous)
//
 ...
 * @see Bun API: Bun.sleep() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
await retryWithBackoff(async () => {
  return await fetch('https://api.example.com/data');
	...
	},
	{
		...
		functionRef: "inspect",
		code: `// Bun Native APIs Used:
// - Bun.inspect() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
//
 ...
 * @see Bun API: Bun.inspect() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
// Output: { config: { features: [ 'arbitrage', 'analytics' ], port: 3001 }, name: 'NEXUS', version: '1.0.0' }`,
	...
	},
	{
		...
		functionRef: "peek",
		code: `// Bun Native APIs Used:
// - Bun.peek() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
//
 ...
 * @see Bun API: Bun.peek() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
if (peeked !== promise) {
  ...
  console.log('Value:', value);
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Bun.deepEquals() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
//
 ...
 * @see Bun API: Bun.deepEquals() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
console.log(Bun.deepEquals(trade1, trade2)); // true`,
	...
	},
	{
		...
		functionRef: "Glob",
		code: `// Bun Native APIs Used:
// - Bun.Glob - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.file() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
//
 ...
 * @see Bun API: Bun.Glob - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
console.log(matchesPattern('src/api/routes.js', '**/*.ts')); // false`,
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Bun.generateHeapSnapshot() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.write() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - JSON.stringify() - JavaScript native
//
 ...
 * @see Bun API: Bun.generateHeapSnapshot() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
// chrome://inspect -> Load -> Select .heapsnapshot file`,
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - new Worker() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 ...
 * @see Bun API: Worker - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
console.log('Processed:', result);`,
	...
	},
	{
		...
		functionRef: "test",
		code: `// Bun Native APIs Used:
// - bun:test - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.nanoseconds() - BUN_DOCS_URLS.DOCS/runtime/bun-apis (for timing)
//
 ...
 * @see Bun API: bun:test - BUN_DOCS_URLS.DOCS/runtime/bun-apis
 */
...
// bun test --bail             # Stop on first failure`,
	...
	},
	{
		...
		api: "bun:test",
		docsUrl: `${BUN_DOCS_URLS.DOCS}/test`,
...
// @version 1.3.0
// @see {@link BUN_DOCS_URLS.DOCS/test|Bun Test Documentation}
 ...
 * \`);
 * 
 * @see {@link BUN_DOCS_URLS.DOCS/test|Bun Test API}
...
// - Bun.hash() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.spawn() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.gc() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
...
monitor.destroy();`,
	...
	},
	{
		...
		code: `// Bun Native APIs Used:
// - Bun.randomUUIDv7() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Bun.gzipSync() - BUN_DOCS_URLS.DOCS/runtime/bun-apis
// - Database (bun:sqlite) - BUN_DOCS_URLS.API_REFERENCE
// - JSON.stringify() - JavaScript native
//
