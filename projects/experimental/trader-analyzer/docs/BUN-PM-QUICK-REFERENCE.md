...
| `bun patch` | Patch packages in node_modules | `bun patch <package>` |
...
# Patch a package (fix bugs, add features)
bun patch react                    # Prepare package for patching
# Edit files in node_modules/react/
bun patch --commit react           # Commit patch to patches/
```
