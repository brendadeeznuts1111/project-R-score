 ...
 * 
 * Pre-built automation templates for DuoPlus RPA system:
...
import { type RPATemplate, type RPAStep } from './duoplus-sdk.js';
...
export class RPATemplateManager {
  ...
  static getAppleIDCreationTemplate(): RPATemplate {
    return {
      ...
      name: 'Apple ID Creation with DuoPlus Integration',
      ...
      steps: [
        {
          ...
          parameters: {
            ...
            timeout: config.getTimeout('default')
          },
          delay: 2000
        },
        {
