...
async function runLiveDemo() {
    ...
    const PUBLIC_URL_BASE = "https://pub-295f9061822d480cbe2b81318d88d774.r2.dev";
    ...
    const manager = new S3R2NativeManager({
        ...
        accessKeyId: process.env.CLOUDFLARE_ACCESS_KEY_ID || "9d3150c383fe3b7844d5bb3086d4a8dc",
        secretAccessKey: process.env.CLOUDFLARE_SECRET_ACCESS_KEY || "fe87d144820f6bb77171493bc53ae8ba2a946ae740296a166faf50860cfab859",
        bucket: process.env.CLOUDFLARE_R2_BUCKET || "apple-id-storage",
    });
