...
export class MySQLParameterBindingGuard {
  ...
  static validateParameter(value: any, index: number): void {
  ...
  private static isIndexable(obj: any): boolean {
    try {
  ...
  private static detectSuspiciousQuery(sql: string, params: any[]): void {
...
export const { validateParameter, safeQuery } = feature("MYSQL_PARAM_GUARD")
  ...
  : {
      validateParameter: (v: any) => {},
      safeQuery: (c: any, s: string, p: any[]) => c.query(s, p)
    };