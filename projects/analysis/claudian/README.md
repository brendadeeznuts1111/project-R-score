...
1. Download `main.js`, `manifest.json`, and `styles.css` from the [latest release](https://github.com/brendadeeznuts1111/obsidian-claude/releases/latest)
...
4. Enter the repository URL: `https://github.com/brendadeeznuts1111/obsidian-claude`
...
1. Clone this repository into your vault's plugins folder:
   ...
   git clone https://github.com/brendadeeznuts1111/obsidian-claude.git
   cd claudian
   ```
...
| Windows (bun) | `bun pm ls -g` | `{root}\@anthropic-ai\claude-code\cli.js` |

> **Note**: On Windows, avoid `.cmd` wrappers. Use `claude.exe` or `cli.js`.

**Alternative**: Add your Node.js bin directory to PATH in Settings → Environment → Custom variables.

### Bun CLI and Node.js not in same directory

If using bun-installed CLI, check if `claude` and `node` are in the same directory:
```bash
...
**Still having issues?** [Open a GitHub issue](https://github.com/brendadeeznuts1111/obsidian-claude/issues) with your platform, CLI path, and error message.
