...
## Release Summary
- **Version:** 1.3.8
- **Timestamp:** 2026-02-01T20-12-42-740Z
- **Config:** ./config.yaml
- **Mode:** PRODUCTION
- **Total Duration:** 0s
...
## Phase Results
- **analysis:** Exit code 0, 32ms
- **validation:** Exit code 2, 16ms
- **deployment:** Exit code 3, 6ms
- **verification:** Exit code 0, 1003ms
...
- **Git Tag:** release-1.3.8-2026-02-01T20-12-42-740Z
...
2. Use git tag `rollback-2026-02-01T20-12-42-740Z` to mark failure point
