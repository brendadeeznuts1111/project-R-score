...
async function decommissionAgent(agentId: string) {
  console.info(`🧹  ZeroFingerprintCleanup: Decommissioning agent ${agentId}...`);
  ...
  try {
    ...
    console.info("⚡  Triggering hardware-level factory reset...");
    ...
    console.info("✅  Reset Command Acknowledged.");
    console.info("💎  Zero data residue remains.");
