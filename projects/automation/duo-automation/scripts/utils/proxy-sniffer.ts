...
async function main() {
  ...
  console.info("\x1b[35m[EMPIRE PRO] Live Proxy Sniffer Active\x1b[0m");
  console.info("--- Monitoring traffic through active proxies ---\n");
  ...
  setInterval(() => {
    ...
    console.info(`${timestamp} | ${method.padEnd(4)} | ${endpoint.padEnd(20)} | ${status} | ${latency}ms`);
  }, 1000);
