...
<head>
    ...
    <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 40px; background: #3b82f6; }
        ...
        .metric { background: #3b82f6; padding: 20px; border-radius: 8px; text-align: center; }
        .metric-value { font-size: 2em; font-weight: bold; color: #007AFF; }
        .metric-label { color: #666; margin-top: 5px; }
        .chart { background: #3b82f6; padding: 20px; border-radius: 8px; margin: 20px 0; font-family: monospace; white-space: pre; }
        .recommendations { background: #3b82f6; padding: 20px; border-radius: 8px; border-left: 4px solid #3b82f6; }
