    ...
    return [
      {
        ...
        deepLink: 'duoplus://dispute/new?type=qr',
        icon: '➕',
        category: 'customer'
      },
      {
        ...
        deepLink: 'duoplus://dispute/upload',
        icon: '📤',
        category: 'customer'
      },
      {
      ...
      },
      {
        ...
        deepLink: 'duoplus://dispute/respond',
        icon: '📝',
        category: 'merchant'
      },
      {
        ...
        deepLink: 'duoplus://dispute/counter-evidence',
        icon: '📋',
        category: 'merchant'
      },
      {
        ...
        deepLink: 'duoplus://dispute/venmo-status',
        icon: '🔍',
        category: 'admin'
      },
      {
        ...
        deepLink: 'duoplus://dispute/report',
        icon: '📊',
        category: 'admin'
      },
      {
        ...
        deepLink: 'duoplus://dispute/escalate',
        icon: '⚠️',
        category: 'admin'
      }
    ];
    ...
    return [
      {
        ...
        deepLink: 'duoplus://dispute/DSP-12345'
      },
      {
        id: 'DSP-12344',
        ...
        deepLink: 'duoplus://dispute/DSP-12344'
      },
      {
        id: 'DSP-12343',
        type: 'refund_issued',
        ...
        deepLink: 'duoplus://dispute/DSP-12343'
      },
      {
        id: 'DSP-12342',
        ...
        deepLink: 'duoplus://dispute/DSP-12342'
      },
      {
        id: 'DSP-12341',
        ...
        deepLink: 'duoplus://dispute/DSP-12341'
      }
    ];
  }
  ...
  generateStatusTimeline(currentStatus: DisputeStatus): Array<{
    ...
    return statusOrder.map((status, index) => {
      ...
      return {
        ...
        deepLink: details?.deepLink || `duoplus://dispute/status/${status.toLowerCase()}`
      };
    });
  }
