...
class CloudflareRegistryDeployer {
  ...
  async deploy() {
    console.log('🚀 Deploying FactoryWager Registry to Cloudflare...');
    ...
    try {
      ...
      console.log('🌐 Registry URL: https://registry.factory-wager.com');
  ...
  private async outputConfig() {
    ...
    console.log(`Main Registry: https://registry.factory-wager-registry.utahj4754.workers.dev`);
    console.log(`NPM Endpoint: https://npm.factory-wager-registry.utahj4754.workers.dev`);
    console.log(`Package Downloads: https://packages.factory-wager-registry.utahj4754.workers.dev`);
    console.log(`API Endpoint: https://registry.factory-wager-registry.utahj4754.workers.dev/@factory-wager`);
    console.log(`Health Check: https://registry.factory-wager-registry.utahj4754.workers.dev/health`);
    console.log(`Search API: https://registry.factory-wager-registry.utahj4754.workers.dev/-/v1/search`);
