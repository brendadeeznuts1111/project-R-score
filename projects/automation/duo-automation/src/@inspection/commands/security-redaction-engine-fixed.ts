/**
 * Security Redaction Engine - Fixed Version
 * 
...
export class SecurityRedactionEngine {
  ...
  private static readonly REDACTION_PATTERNS = {
    ...
    bitcoinAddresses: {
      pattern: /\\b(bc1|[13])[a-zA-Z-HJ-NP-Z0-9]{25,39}\\b/g,
    ...
    return [
      {
        ...
        severity: 'critical',
        examples: ['api_key: sk_live_12345', 'password: secret123', 'eyJhbGciOiJIUzI1NiIs']
      },
      {
        name: 'pii',
