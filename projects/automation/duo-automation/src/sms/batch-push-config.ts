 ...
 * 
 * Manages bulk configuration deployment to FactoryWager devices:
...
import { FactoryWagerSDK, type BatchPushRequest, type BatchPushResult, type Device } from './factory-wager-sdk.js';
...
export class BatchConfigManager {
  ...
  private maxDevices = 500; // FactoryWager limit
