...
2. **Create Bucket**:
   - Click "Create bucket"
   - **Bucket name**: `factory-wager-packages`
...
```json
{
  "reporting": {
    "cloudflareR2": {
      ...
      "bucketName": "factory-wager-packages",
      "accessKeyId": "69765dd738766bca38be63e7d0192cf8",
      "secretAccessKey": "1d9326ffb0c59ebecb612f401a87f71942574984375fb283fc4359630d7d929a",
      "region": "auto",
...
All placeholders have been replaced with verified production values:

- **R2 Access Key ID**: `69765dd738766bca38be63e7d0192cf8`
- **R2 Secret Access Key**: `1d9326ffb0c59ebecb612f401a87f71942574984375fb283fc4359630d7d929a`
- **R2 Bucket**: `factory-wager-packages`
- **R2 Endpoint**: `https://7a470541a704caaf91e71efccc78fd36.r2.cloudflarestorage.com`
