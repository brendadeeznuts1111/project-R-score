#!/usr/bin/env bun
/**
 * Demo: --cpu-prof-interval flag (scratch playground only).
 * Harness SSOT: docs/harness/tenants/bun-bench-profiling.md
 */

console.info('Bun: CPU Profiling Interval (scratch demo)\n');
