...
| # | Feature | Class | API | Types / Interfaces | Bun API | Type | Version | Default | Bench | Status | Test File | Example | PR | Commit |
|---|---------|-------|-----|-------------------|---------|------|---------|---------|-------|--------|-----------|---------|----|--------|
| 1 | `--parallel` | CLI | `bun run` | — | `Bun.spawn` (internal) | New | 1.3.9 | — | 2.1x vs sequential | ✅ Pass | `package.json` scripts | [parallel-scripts.sh](examples/parallel-scripts.sh) | [#26551](https://github.com/oven-sh/bun/pull/26551) | `bb4d5b9` |
| 2 | `--sequential` | CLI | `bun run` | — | `Bun.spawn` (internal) | New | 1.3.9 | — | baseline | ✅ Pass | `package.json` scripts | [parallel-scripts.sh](examples/parallel-scripts.sh) | [#26551](https://github.com/oven-sh/bun/pull/26551) | `bb4d5b9` |
| 3 | `--no-exit-on-error` | CLI | `bun run` | — | — | New | 1.3.9 | exits on error | — | ✅ Pass | `fail.ts` | [parallel-scripts.sh](examples/parallel-scripts.sh) | [#26551](https://github.com/oven-sh/bun/pull/26551) | `bb4d5b9` |
| 4 | Glob script names `"build:*"` | CLI | `bun run` | — | — | New | 1.3.9 | — | — | ✅ Pass | `build-*.ts` | [parallel-scripts.sh](examples/parallel-scripts.sh) | [#26551](https://github.com/oven-sh/bun/pull/26551) | `bb4d5b9` |
| 5 | Pre/post script grouping | CLI | `bun run` | — | — | Enhancement | 1.3.9 | pre/post ran standalone | — | ✅ Pass | `package.json` prebuild/postbuild | [workspace-parallel.sh](examples/workspace-parallel.sh) | [#26551](https://github.com/oven-sh/bun/pull/26551) | `bb4d5b9` |
| 6 | `Symbol.dispose` mock/spyOn | Testing | `bun:test` | `Mock`, `SpyInstance` | `mock()`, `spyOn()` | New | 1.3.9 | manual `mockRestore()` | — | ✅ 4/4 | `test-symbol-dispose.test.ts` | [symbol-dispose-spyon.ts](examples/symbol-dispose-spyon.ts) | [#26692](https://github.com/oven-sh/bun/pull/26692) | `d23312d` |
| 7 | HTTP/2 connection upgrade | Networking | `node:http2` / `node:net` | `Http2SecureServer`, `Socket` | — | Fix | 1.3.9 | broken emit pattern | — | ✅ Pass | `h2-blog-example.ts` | [h2-connection-upgrade.ts](examples/h2-connection-upgrade.ts) | [#26539](https://github.com/oven-sh/bun/pull/26539) | `0ad562d` |
| 8 | Faster `String.trim` | JSC Engine | `String.prototype` | `String` | — | Enhancement | 1.3.9 | worked, slower | 1M in 22.6ms | ✅ Bench | `test-v139-features.ts` | — | [#26769](https://github.com/oven-sh/bun/pull/26769) | `6c70ce2` |
| 9 | Faster `String.startsWith` | JSC Engine | `String.prototype` | `String` | — | Enhancement | 1.3.9 | worked, slower | 1M in 1.5ms | ✅ Bench | `test-v139-features.ts` | — | [#26769](https://github.com/oven-sh/bun/pull/26769) | `6c70ce2` |
| 10 | RegExp SIMD acceleration | JSC Engine | `RegExp.prototype` | `RegExp` | — | Enhancement | 1.3.9 | no SIMD | 1M exec in 30.2ms | ✅ Bench | `test-jsc-upgrade.ts` | [regexp-jit-bench.ts](examples/regexp-jit-bench.ts) | [#26769](https://github.com/oven-sh/bun/pull/26769) | `6c70ce2` |
| 11 | RegExp fixed-count parens | JSC Engine | `RegExp` JIT | `RegExp` | — | Enhancement | 1.3.9 | slower JIT path | 1M in 11.9ms | ✅ Bench | `test-jsc-upgrade.ts` | [regexp-jit-bench.ts](examples/regexp-jit-bench.ts) | [#26769](https://github.com/oven-sh/bun/pull/26769) | `6c70ce2` |
| 12 | `Set#size` / `Map#size` DFG/FTL | JSC Engine | `Set` / `Map` | `Set<T>`, `Map<K,V>` | — | Enhancement | 1.3.9 | not inlined | 10M in 7.3ms / 5.9ms | ✅ Bench | `test-jsc-upgrade.ts` | [jsc-engine-bench.ts](examples/jsc-engine-bench.ts) | [#26769](https://github.com/oven-sh/bun/pull/26769) | `6c70ce2` |
| 13 | `Object.defineProperty` DFG/FTL | JSC Engine | `Object` | `PropertyDescriptor` | — | Enhancement | 1.3.9 | interpreter only | 1M in 64.6ms | ✅ Bench | `test-jsc-upgrade.ts` | [jsc-engine-bench.ts](examples/jsc-engine-bench.ts) | [#26769](https://github.com/oven-sh/bun/pull/26769) | `6c70ce2` |
| 14 | `String#replace` returns Ropes | JSC Engine | `String.prototype` | `String` | — | Enhancement | 1.3.9 | eager concat | 1M in 94.5ms | ✅ Bench | `test-jsc-upgrade.ts` | [jsc-engine-bench.ts](examples/jsc-engine-bench.ts) | [#26769](https://github.com/oven-sh/bun/pull/26769) | `6c70ce2` |
| 15 | Faster `Bun.markdown.html` | Bun Native | `Bun.markdown` | `MarkdownOptions` | `Bun.markdown.html()` | Enhancement | 1.3.9 | worked, slower | 10K in 10.3ms | ✅ Bench | `test-jsc-upgrade.ts` | [markdown-api.ts](examples/markdown-api.ts) | [#26644](https://github.com/oven-sh/bun/pull/26644) | `7f498a2` |
| 16 | Faster `Bun.markdown.react` | Bun Native | `Bun.markdown` | `MarkdownOptions` | `Bun.markdown.react()` | Enhancement | 1.3.9 | worked, slower | 10K in 24.0ms | ✅ Bench | `test-jsc-upgrade.ts` | [markdown-api.ts](examples/markdown-api.ts) | [#26668](https://github.com/oven-sh/bun/pull/26668) | `de8c754` |
| 17 | `AbortSignal.abort()` perf | Web API | `AbortSignal` | `AbortSignal`, `AbortController` | — | Enhancement | 1.3.9 | created Event always | 100K in 32.4ms | ✅ Bench | `test-v139-features.ts` | [abort-signal-perf.ts](examples/abort-signal-perf.ts) | [#26686](https://github.com/oven-sh/bun/pull/26686) | `eba4da2` |
| 18 | `Bun.markdown` API | Bun Native | `Bun.markdown.html/render/react` | `MarkdownOptions` | `Bun.markdown` | Existing | 1.3.0 | — | — | ✅ Pass | `test-v139-features.ts` | [markdown-api.ts](examples/markdown-api.ts) | — | — |
| 19 | CRC32 seed parameter | Bun Native | `Bun.hash.crc32` | — | `Bun.hash.crc32()` | Enhancement | 1.3.9 | no seed option | — | ✅ Pass | `test-v139-features.ts` | [crc32-seed.ts](examples/crc32-seed.ts) | [#26754](https://github.com/oven-sh/bun/pull/26754) | `e5cd034` |
| 20 | ESM bytecode compilation | Bundler | `bun build --compile` | `BuildConfig` | `Bun.build()` | New | 1.3.9 | CJS only | — | ✅ Pass | `test-esm-bytecode.ts` | [esm-compile.sh](examples/esm-compile.sh) | [#26402](https://github.com/oven-sh/bun/pull/26402) | `71ce550` |
| 21 | NO_PROXY for explicit proxy | Networking | `fetch` / `WebSocket` | `RequestInit`, `WebSocket` | `fetch()` | Fix | 1.3.9 | NO_PROXY ignored | — | ✅ Pass | `test-no-proxy.ts` | [no-proxy.ts](examples/no-proxy.ts) | [#26608](https://github.com/oven-sh/bun/pull/26608) | `a14a89c` |
| 22 | stringWidth Thai/Lao fix | Bun Native | `stringWidth` | — | `Bun.stringWidth()` | Fix | 1.3.9 | width=0 (wrong) | — | ✅ 12/12 | `test-stringwidth.ts` | [stringwidth.ts](examples/stringwidth.ts) | [#26728](https://github.com/oven-sh/bun/pull/26728) | `0e386c4` |
| 23 | `--cpu-prof-interval` | CLI | `bun run` CLI | — | — | New | 1.3.9 | 1000us fixed | — | ✅ Pass | `test-cpu-prof.ts` | [cpu-profiling.sh](examples/cpu-profiling.sh) | [#26620](https://github.com/oven-sh/bun/pull/26620) | `1337f5d` |
| 24 | `--cpu-prof-md` | CLI | `bun run` CLI | — | — | New | 1.3.9 | JSON only | — | ✅ Pass | `test-cpu-prof.ts` | [cpu-profiling.sh](examples/cpu-profiling.sh) | — | — |
| 25 | SIGILL fix ARMv8.0 aarch64 | Runtime | Runtime | — | — | Fix | 1.3.9 | SIGILL crash | — | 🖥️ ARM only | — | — | [#26586](https://github.com/oven-sh/bun/pull/26586) | `adc1a6b` |
| 26 | Hardened chunked encoding | Security | HTTP parser | — | — | Fix | 1.3.9 | vulnerable | — | 🔒 Internal | — | — | [#26594](https://github.com/oven-sh/bun/pull/26594) | `8f61adf` |
| 27 | Shell double-free fix | Runtime | `Bun.$` | `ShellOutput` | `Bun.$` | Fix | 1.3.9 | possible crash | — | 🔒 Internal | — | — | [#26626](https://github.com/oven-sh/bun/pull/26626) | `56b5be4` |
| 28 | WebSocket blob binaryType fix | Networking | `WebSocket` | `WebSocket` | — | Fix | 1.3.9 | missing ref count | — | 🔒 Internal | — | — | [#26670](https://github.com/oven-sh/bun/pull/26670) | `89d2b1c` |
| 29 | fs `.` path normalization | Node Compat | `node:fs` | `PathLike` | — | Fix | 1.3.9 | broken on Windows | — | 🖥️ Windows | — | — | [#26634](https://github.com/oven-sh/bun/pull/26634) | `ddefa11` |
| 30 | Socket.reload() types fix | Bun Native | `Bun.Socket` | `Socket<T>`, `SocketHandler` | `Bun.listen()` | Fix (types) | 1.3.9 | wrong type signature | — | 📝 Types | — | — | [#26291](https://github.com/oven-sh/bun/pull/26291) | `a524634` |
| 31 | SIMD compile target types | Bundler | `Bun.Build` | `BuildConfig`, `Target` | `Bun.build()` | Fix (types) | 1.3.9 | missing variants | — | 📝 Types | — | — | [#26248](https://github.com/oven-sh/bun/pull/26248) / [#26607](https://github.com/oven-sh/bun/pull/26607) | `f648483` / `01fa610` |
| 32 | HTTP tunnel mode fix | Networking | HTTP proxy | — | — | Fix | 1.3.9 | wrong tunnel for absolute URLs | — | 🔒 Internal | — | — | [#26737](https://github.com/oven-sh/bun/pull/26737) | `63a323a` |

**Legend:** ✅ = verified hands-on · 🔒 = internal/security fix · 🖥️ = platform-specific · 📝 = type definitions

**Classes:** CLI · Testing · Networking · JSC Engine · Bun Native · Bundler · Web API · Runtime · Security · Node Compat
