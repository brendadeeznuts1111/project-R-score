...
// Features #12-14 — PR #26769 — Enhancement in Bun 1.3.9
//
// JSC upgrade brings DFG/FTL inlining for:
// - Set#size / Map#size (inline caches)
...
function bench(label: string, fn: () => void, n: number): void {
  ...
  console.log(`${label.padEnd(36)} ${n.toLocaleString()} ops in ${elapsed.toFixed(1)}ms`);
}

console.log("=== JSC Engine DFG/FTL Benchmarks ===\n");

// --- Set#size / Map#size (Feature #12) ---
console.log("Set#size / Map#size (DFG/FTL inlined):");
{
