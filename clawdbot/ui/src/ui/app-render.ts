      ...
      <aside class="nav ${state.settings.navCollapsed ? "nav--collapsed" : ""}">
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            ...
            <a
              class="nav-item nav-item--external"
              href="https://github.com/clawdbot/clawdbot/blob/main/CHANGELOG.md"
              target="_blank"
              rel="noreferrer"
              title="Changelog (opens in new tab)"
            >
              <span class="nav-item__icon" aria-hidden="true">📝</span>
              <span class="nav-item__text">Changelog</span>
            </a>
            <a
              class="nav-item nav-item--external"
              href="https://github.com/clawdbot/clawdbot/commits/main"
              target="_blank"
              rel="noreferrer"
              title="Commits (opens in new tab)"
            >
              <span class="nav-item__icon" aria-hidden="true">🔄</span>
              <span class="nav-item__text">Commits</span>
            </a>
          </div>
        </div>
      </aside>
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "overview"
          ? renderOverview({
              ...
              onShowQrCode: () => state.showQrCode(),
              onCloseQrCode: () => state.closeQrCode(),
            })
          : nothing}
