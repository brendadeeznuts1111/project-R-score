...
| **Deep equals** | test | Bun ≥1.0 | `Bun.deepEquals(a, b, strict?)` | — | `expect().toEqual` internals · inventory diffs | Implemented | [Bun.deepEquals](https://bun.com/docs/runtime/utils#bun-deepequals) | `Bun.deepEquals(a, b, true)` |
...
| **String width (Unicode)** | display | Bun ≥1.0 | `Bun.stringWidth(s, opts?)` | — | snapshot-core pad · cli-chrome frames | Implemented | [Bun.stringWidth](https://bun.com/docs/runtime/utils#bun-stringwidth) | `Bun.stringWidth(s, { countAnsiEscapeCodes: false })` |
