...
| **Security scanner** | security | Bun ≥1.4 | `bun pm scan` · `[install.security] scanner` | — | `portal-cli scanner` (status · scan · configure · install · init) | Implemented | [Security Scanner API](https://bun.com/docs/pm/security-scanner-api) | `bun run portal-cli scanner status` |
