...
| **Curated runtime flags catalog** | cli | Bun ≥1.0 | `config/runtime-flags.json` SSOT (14 curated · full harvest set) · shortcode/takesValue/behavior | — | `portal-cli flags` · `portal-cli --help` · doctor `runtime-flags-catalog` | Implemented | [runtime options](https://bun.com/docs/runtime/index#general-execution-options) | `bun run portal:flags` · `portal-cli flags --all` · `portal-cli doctor` |
