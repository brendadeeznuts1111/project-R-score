...
| **Image chart generation** | image | Bun ≥1.3.14 | `new Bun.Image(file).resize(800, 600).png()` | — | report and evidence chart rendering | Implemented | [Bun.Image](https://bun.com/docs/runtime/image#input) | `const png = await new Bun.Image(await Bun.file("chart.png").arrayBuffer()).resize(800, 600).png().bytes();` |
