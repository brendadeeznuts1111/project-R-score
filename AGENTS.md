...
| CLI flag allowlists / unknown `--*` guard        | [`docs/harness/cli-constants-flags.md`](docs/harness/cli-constants-flags.md) · [`lib/docs/ref-id-tool-flags.ts`](lib/docs/ref-id-tool-flags.ts) · `ALLOWED_LONG_REGISTRY` · `bun run cli:flags:check` · `bun test tests/docs-ref-id-tool-exports.test.ts`                                                                                                                                                                                                 |
