...
| Bookmaker registry                                | [`docs/harness/tenants/bookmakers-registry.md`](docs/harness/tenants/bookmakers-registry.md) · `/portal/bookmakers/` · `/registry/bookmakers.json` · `@factorywager/bookmakers` artifact · `bun run bookmakers:bake` · `weave --package` runbook [`docs/package-registry.md`](docs/package-registry.md)                                                                                                                                                                                                                |
...
- **Task routing:**
  ...
  - Console output formatting →
    ...
    [`lib/bun-runtime.md`](lib/bun-runtime.md) · `bun run check:console-format`
    ...
    [`lib/console-format-scan.ts`](lib/console-format-scan.ts) · board
  ...
  - Vault drift (Proton Pass) → `bun run vault:health:bake` (exit 1 when an
    ...
    [`lib/security/vault-health.ts`](lib/security/vault-health.ts); restore
  ...
  - Test failures board → `bun run failures:bake` (JUnit → `/portal/failures/` +
    ...
    [`lib/failure-report.ts`](lib/failure-report.ts); CI bakes via test-sharded
    `failures-report` job)
...
[`lib/bun-runtime.md`](lib/bun-runtime.md). Related:
