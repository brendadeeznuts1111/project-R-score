...
| **Vault health gate** | test | Bun ≥1.0 | `expect().toMatchSnapshot()` | pass-cli list (bake only) | `portal-cli vault health` · local harness | Implemented | [snapshots](https://bun.com/docs/test/snapshots) · `/portal/vault/` | `bun run portal-cli vault health` |
