...
| **Console depth flag**            | runtime   | Bun ≥1.0                  | `bun --console-depth=N`                                                                                                                    | —                                                           | portal-cli child spawns · `lib/console-depth.ts`                                                         | Implemented | [runtime · --console-depth](https://bun.com/docs/runtime/console#object-inspection-depth)                                                                                                                           | `bun tools/portal-cli.ts --console-depth=4 probe lockfile`                                                                                        |
