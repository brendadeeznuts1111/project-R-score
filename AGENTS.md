...
| **Security scanner** | security | Bun ≥1.4 | `bun pm scan` · `[install.security] scanner` | `SOCKET_API_KEY` (optional) | `portal-cli scanner` (status · doctor · vault · scan · configure) | Implemented | [Security Scanner API](https://bun.com/docs/pm/security-scanner-api) | `bun run portal-cli scanner doctor` |
