...
| Factory Telegram | [`docs/harness/tenants/telegram-factory.md`](docs/harness/tenants/telegram-factory.md) · `bun run telegram:verify` · `telegram:ops:consume` · handshake: `telegram:handshake:verify` · `telegram:handshake:desk` · `telegram:handshake:readiness` · `telegram:handshake:invite-gap` · [`lib/telegram/`](lib/telegram/) |
...
- **Task routing:**
  ...
  - Factory Telegram → [`docs/harness/tenants/telegram-factory.md`](docs/harness/tenants/telegram-factory.md) · `loadTelegramEnv` in [`lib/telegram/telegram-config.ts`](lib/telegram/telegram-config.ts) · `bun run telegram:verify` · handshake: `telegram:handshake:verify` · `telegram:handshake:desk` · `telegram:handshake:readiness` · `telegram:handshake:invite-gap` · [`partner-package-group-handshake.md`](docs/harness/tenants/partner-package-group-handshake.md)
