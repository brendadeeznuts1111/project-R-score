...
/** Exported so tests can lock stub body ↔ committed evidence digest. */
export const EVIDENCE_BODY = `{"event":"meta","note":"FactoryWager audit-catalog sample — synthetic Nagata-type fiber demo, not a production sportsbook claim"}
...
{"event":"proof","kind":"synthetic-fiber-curve","relatedConcepts":["nagata-map","jacobian-nullspace","sha3-integrity"]}
`;
