...
results.push(
  bench(
    'WebAssembly.compile + exports/imports',
    async () => {
...
console.info(
  `  WebAssembly.compile (minimal): ${compileMini?.['ns/op']}ns/op (${compileMini?.['ops/s']} ops/s)`
);
