...
export const CANONICAL_REFS: Record<string, string> = {
  ...
  'Bun.markdown.html heading-ids': 'https://bun.com/docs/runtime/markdown#heading-ids',
  'callback-signature': 'https://bun.com/docs/runtime/markdown#callback-signature',
  'Bun.markdown.render callback signature':
    'https://bun.com/docs/runtime/markdown#callback-signature',
  'block-callbacks': 'https://bun.com/docs/runtime/markdown#block-callbacks',
  'Bun.markdown.render block callbacks': 'https://bun.com/docs/runtime/markdown#block-callbacks',
  'list-item-meta': 'https://bun.com/docs/runtime/markdown#list-item-meta',
  ...
  'Bun.markdown.react SSR': 'https://bun.com/docs/runtime/markdown#server-side-rendering',
