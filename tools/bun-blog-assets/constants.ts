...
export const BUN_14_MEDIA_RIGHTS_SCOPE = 'bun-1.4-release-blog-media';
export const BUN_LICENSE_URL = 'https://bun.com/docs/project/license';
export const BUN_PRESS_KIT_URL = 'https://bun.com/press-kit';
