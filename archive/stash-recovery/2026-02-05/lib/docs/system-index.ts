    ...
    const domains = [
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 14 },
        url: 'https://bun.sh',
      ...
      },
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 15 },
        url: 'https://bun.com',
      ...
      },
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 16 },
        url: 'https://bun.dev',
    ...
    const providers = [
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 24 },
      ...
      },
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 26 },
      ...
      },
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 27 },
    ...
    const categories = [
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 61 },
      ...
      },
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 62 },
      ...
      },
      {
        ...
        location: { file: '/lib/docs/constants/domains.ts', line: 81 },
    ...
    const fragments = [
      {
        ...
        location: { file: '/lib/docs/constants/fragments.ts', line: 53 },
        url: '#typedarray',
        type: 'technical_docs' as DocumentationURLType,
        audience: ['developers'] as DocumentationUserType[],
      ...
      },
      {
        ...
        location: { file: '/lib/docs/constants/fragments.ts', line: 65 },
        url: '#fetch',
        type: 'api_reference' as DocumentationURLType,
        audience: ['developers'] as DocumentationUserType[],
    ...
    const paths = [
      {
        ...
        location: {
          file: '/lib/docs/constants/categories.ts',
