...
| **Summary / portal**     | [`ops-summary.ts`](ops-summary.ts) · [`ops-summary-proof.ts`](ops-summary-proof.ts)                                                                                                              | domain ∪ proof strip · [`ops-summary-diagnose.ts`](ops-summary-diagnose.ts) · [`ops-sync.ts`](ops-sync.ts) · [`portal-snapshot-cron.ts`](portal-snapshot-cron.ts) · [`snapshot-cron.ts`](snapshot-cron.ts)                                                                                                                                                          |
