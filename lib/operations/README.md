...
| **Summary / portal**     | [`ops-summary.ts`](ops-summary.ts) · [`ops-summary-proof.ts`](ops-summary-proof.ts)                                                                                                              | domain ∪ proof strip · [`ops-summary-diagnose.ts`](ops-summary-diagnose.ts) · [`ops-summary-diagnose-format.ts`](ops-summary-diagnose-format.ts) · [`ops-sync.ts`](ops-sync.ts) · [`portal-snapshot-cron.ts`](portal-snapshot-cron.ts) · [`snapshot-cron.ts`](snapshot-cron.ts)                                                                                     |
...
| **Limits / raises**      | [`limit-raise-agent-api.ts`](limit-raise-agent-api.ts) · [`limit-raise-report.ts`](limit-raise-report.ts)                                                                                        | [`limit-raises-snapshot.ts`](limit-raises-snapshot.ts) · [`limit-patterns.ts`](limit-patterns.ts) · [`limit-betlog-export.ts`](limit-betlog-export.ts) · [`partner-analytics-repo.ts`](partner-analytics-repo.ts) · [`anchor-stability.ts`](anchor-stability.ts) · [`limits/`](limits/) · [partner-limits](../../docs/harness/tenants/partner-limits.md)            |
...
| **Scrapers**             | [`scrapers/domain.ts`](scrapers/domain.ts) · [`scrapers/limit-observation-wire.ts`](scrapers/limit-observation-wire.ts) · [`scrapers/scrape-wire-taxonomy.ts`](scrapers/scrape-wire-taxonomy.ts) | [`scrapers/README.md`](scrapers/README.md) · [`scrapers/books/`](scrapers/books/) · [`scrapers/run-book-agent.ts`](scrapers/run-book-agent.ts) · [`scrapers/scrape-cron.ts`](scrapers/scrape-cron.ts) · [`scrapers/webview-html.ts`](scrapers/webview-html.ts) · `config/scrape-agents.toml`                                                                        |
...
| Topic                     | Guidance                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ops-summary façade**    | Legitimate portal bake sink (`buildOpsSummary` → live API + `ops:snapshot`). **Split:** domain = `buildOpsDomainSummary` ([`ops-summary.ts`](ops-summary.ts)); proof strip = `buildOpsSummaryProofStrip` ([`ops-summary-proof.ts`](ops-summary-proof.ts)); full wire = domain ∪ proof (flat keys, no nested `proof`). Prefer domain-only when SQLite product state is enough. |
...
| Builder SSOT          | [`ops-summary.ts`](ops-summary.ts) + [`ops-summary-proof.ts`](ops-summary-proof.ts) | Domain ∪ proof strip → flat wire               |
