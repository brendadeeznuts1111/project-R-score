...
| Color / theme         | [`theme.ts`](./theme.ts) · [`theme-token-resolve.ts`](./theme-token-resolve.ts) · [`portal-kernel-palette.ts`](./portal-kernel-palette.ts) · [`color-kernel-align.ts`](./color-kernel-align.ts) · [`color-kernel-paths.ts`](./color-kernel-paths.ts) · [`component-color-align.ts`](./component-color-align.ts) · [`claim-reporter.ts`](./claim-reporter.ts) | theme.jsonc aliases vs kernels                                              |
