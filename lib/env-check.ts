...
export const ENV_CHECK_SPECS: Spec[] = [
  ...
  },
  {
    ...
    severity: 'optional',
    secret: true,
    anyOf: ['TELEGRAM_BOT_FACTORY', 'TELEGRAM_BOT_TOKEN'],
    note: 'factory portal webhook + ops consumer; verify: bun run telegram:verify',
  },
  {
    ...
    severity: 'optional',
    secret: true,
    note: 'legacy alias for factory bot token',
  },
  {
    key: 'TELEGRAM_OPS_CHAT_ID',
    group: 'ops',
    severity: 'optional',
    note: 'supergroup chat id for ops/alerts projector (forum topics via TELEGRAM_TOPICS)',
  },
  {
    key: 'TELEGRAM_TOPICS',
    group: 'ops',
    severity: 'optional',
    note: 'JSON map logical topic → message_thread_id (e.g. {"ops":2,"alerts":5})',
  },
  {
    ...
    severity: 'optional',
    secret: true,
    note: 'setWebhook secret_token for factory tenant',
  },
  {
