...
| **Partner ops / colors**      | [`partner-ops-color-kernel.ts`](partner-ops-color-kernel.ts)                      | [`partner-ops-events.ts`](partner-ops-events.ts) · [`partner-ops-glossary.ts`](partner-ops-glossary.ts) · [`partner-ops-registry.ts`](partner-ops-registry.ts) · [`partner-notifications.ts`](partner-notifications.ts) · [`partner-notification-prefs.ts`](partner-notification-prefs.ts) · [`partner-forum-accounting.ts`](partner-forum-accounting.ts)                                                                                                                                                                                                                                                                                                                                                                                          |
