...
export const PORTAL_WEAVE_ARTIFACTS: PortalWeaveArtifact[] = [
  ...
  },
  {
    ...
    label: 'bun-1.4-project-media',
    href: '/registry/bun-1.4-project-media.json',
    note: 'FactoryWager-generated Bun runtime proof media · separate from official Bun release assets and feeds',
    group: 'registry',
    cli: 'bun run generate:bun-1.4-palette-clip',
    purpose: 'ui',
  },
  {
    id: 'bun-1-4-color-formats',
    label: 'bun-1.4-color-formats',
    href: '/registry/bun-1.4-color-formats.json',
    note: 'Bun 1.4 runtime-baked advanced color input and output support matrix',
    group: 'registry',
    cli: 'bun run bun-1.4:color-formats:bake',
    purpose: 'ui',
  },
  {
