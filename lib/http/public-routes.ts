...
export const SIMD_ROUTES: PublicRouteDef[] = [
  ...
  },
  {
    ...
    critical: true,
    okStatuses: [200, 400],
    note: 'serve-public index 200 · Pages R2 gateway empty-key validation 400',
  },
  {
    ...
    kind: 'simd-route',
    okStatuses: [200, 400],
    note: 'serve-public aggregate 200 · Pages R2 gateway key validation 400',
  },
  {
    ...
    kind: 'simd-route',
    okStatuses: [200, 400],
    note: 'serve-public search 200 · Pages R2 gateway key validation 400',
  },
  {
    path: '/monitoring',
