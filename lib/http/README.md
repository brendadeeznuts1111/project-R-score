...
| Fetch / content wire    | [`fetch-headers.ts`](fetch-headers.ts) · [`fetch-preconnect.ts`](fetch-preconnect.ts) · [`ip-authority.ts`](ip-authority.ts) · [`content-type.ts`](content-type.ts) · [`form-upload.ts`](form-upload.ts) · [`data-etag.ts`](data-etag.ts) · [`data-source.ts`](data-source.ts) · [`sha256.ts`](sha256.ts)                                            | Outbound/inbound HTTP primitives                 |
