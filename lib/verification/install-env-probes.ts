...
export const SCOPED_REGISTRY_LANES = [
  {
    id: 'env-npm-read-url',
    label: 'FACTORY_WAGER_NPM_REGISTRY_URL',
    resolveUrl: () => Bun.env.FACTORY_WAGER_NPM_REGISTRY_URL || '',
    resolveArtifactOrigin: () => Bun.env.FACTORY_WAGER_REGISTRY_ORIGIN || '',
  },
  {
  ...
  {
    id: 'production-apex',
    label: 'registry.factory-wager.com public read planes',
