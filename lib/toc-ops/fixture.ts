...
export function buildDemoTocOpsFixture(generatedAt = new Date().toISOString()): TocOpsSnapshot {
  ...
  const summary: TocOpsSnapshot['summary'] = {
    ...
    wdQueuedTotal: channel.wdQueuedTotal,
    wdBlockedTotal: channel.wdBlockedTotal,
    exposureAging72hPlus: channel.exposureAging72hPlus,
    onbChecklistPending: channel.onbChecklistPending,
    settlementSlots7d: channel.settlementSlots7d,
    constraintRopeCount: channel.constraintRopeCount,
    playSettlementPending: channel.playSettlementPending,
    exceptionResolutionOpen: channel.exceptionResolutionOpen,
    botCommands24h: channel.botCommands24h,
    bicHandoffsTotal: channel.bicHandoffsTotal,
    warmPlaybookPending: channel.warmPlaybookPending,
    phoneLogEvents: channel.phoneLogEvents,
    avgLiquidityUtilPct: channel.avgLiquidityUtilPct,
    fundCorridorsBlocked: channel.fundCorridorsBlocked,
    railUtilHighCount: channel.railUtilHighCount,
    accountGatesFailed: channel.accountGatesFailed,
    capitalLocationMoves: channel.capitalLocationMoves,
    pendingDeployItems: channel.pendingDeployItems,
    playInstructionsStale: channel.playInstructionsStale,
    dealSplitDrift: channel.dealSplitDrift,
  };
