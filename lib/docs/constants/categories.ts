...
import { DocumentationProvider, DocumentationCategory, DocumentationDomain } from './domains';
...
export const INTELLIGENT_ROUTING_RULES = {
  ...
  topicRouting: {
    typedarray: {
      developers: {
        ...
        fallback: {
          ...
          category: DocumentationCategory.EXAMPLES_TUTORIALS,
          path: 'TUTORIALS',
        },
      },
      beginners: {
        ...
        secondary: {
          ...
          category: DocumentationCategory.EXAMPLES_TUTORIALS,
          path: 'INTERACTIVE_API',
        },
        fallback: {
          provider: DocumentationProvider.BUN_REFERENCE,
          category: DocumentationCategory.API_REFERENCE,
          path: 'INTERACTIVE_EXAMPLES',
        },
      },
      educators: {
        primary: {
    ...
    'getting-started': {
      developers: {
        primary: {
          provider: DocumentationProvider.BUN_OFFICIAL,
          category: DocumentationCategory.INSTALLATION,
          path: 'OVERVIEW',
        },
        secondary: {
          provider: DocumentationProvider.BUN_REFERENCE,
    ...
    cli: {
      developers: {
        ...
        fallback: {
          provider: DocumentationProvider.BUN_GUIDES,
          category: DocumentationCategory.BEST_PRACTICES,
    ...
    rss: {
      all_users: {
        ...
        secondary: {
          provider: DocumentationProvider.BUN_RSS,
          category: DocumentationCategory.BLOG_POSTS,
          path: 'BLOG_INDEX',
        },
        fallback: {
          provider: DocumentationProvider.BUN_RSS,
          category: DocumentationCategory.RELEASE_ANNOUNCEMENTS,
          path: 'RELEASES_INDEX',
        },
      },
      developers: {
  ...
  contextRouting: {
    'error-debugging': {
      primary: {
        provider: DocumentationProvider.BUN_GUIDES,
        category: DocumentationCategory.TROUBLESHOOTING,
        path: 'DEBUGGING',
      },
      secondary: {
        provider: DocumentationProvider.BUN_OFFICIAL,
    ...
    'performance-optimization': {
      primary: {
        provider: DocumentationProvider.BUN_OFFICIAL,
        category: DocumentationCategory.PERFORMANCE,
        path: 'OPTIMIZATION_GUIDES',
      },
      secondary: {
        provider: DocumentationProvider.BUN_GUIDES,
        category: DocumentationCategory.BEST_PRACTICES,
      ...
      fallback: {
        provider: DocumentationProvider.BUN_OFFICIAL,
        category: DocumentationCategory.BENCHMARKS,
        path: 'OVERVIEW',
      },
    },
    ...
    'migration-project': {
      primary: {
        provider: DocumentationProvider.BUN_GUIDES,
        category: DocumentationCategory.MIGRATION_GUIDES,
        path: 'OVERVIEW',
      },
      secondary: {
        provider: DocumentationProvider.BUN_OFFICIAL,
        category: DocumentationCategory.MIGRATION,
        path: 'OVERVIEW',
      },
      fallback: {
        provider: DocumentationProvider.BUN_REFERENCE,
  ...
  formatRouting: {
    ...
    video: {
      ...
      fallback: {
        provider: DocumentationProvider.BUN_GUIDES,
        category: DocumentationCategory.COMMUNITY_RESOURCES,
        path: 'EVENTS',
      },
    },
...
export class IntelligentRouting {
   ...
   */
  static getAllRoutesForTopic(topic: string): Record<
    string,
    {
      primary: any;
      alternatives: any[];
