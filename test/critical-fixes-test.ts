// test/critical-fixes-test.ts - Simple test for critical security fixes
// Tests the most critical fixes without relying on runtime feature checking
...
async function testAsyncInitializationFix(): Promise<boolean> {
  ...
  try {
    ...
    // Test health check (this should wait for initialization)
