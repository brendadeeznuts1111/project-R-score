...
## Release Summary
- **Version:** 1.5.0
- **Timestamp:** 2026-02-01T20-13-19-695Z
- **Config:** ./config.yaml
- **Mode:** PRODUCTION
- **Total Duration:** 0s
...
- **Git Tag:** release-1.5.0-2026-02-01T20-13-19-695Z
...
2. Use git tag `rollback-2026-02-01T20-13-19-695Z` to mark failure point
