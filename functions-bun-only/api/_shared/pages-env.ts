/**
 * Shared Pages Function helpers.
 */

import type { RegistryPagesEnv } from '../../../lib/pages/r2-types.ts';
...
export function requireBucket(env: RegistryPagesEnv): NonNullable<RegistryPagesEnv['REGISTRY_BUCKET']> {
