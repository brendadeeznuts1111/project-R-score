...
export const BUN_DX_CATALOG: BunDxEntry[] = [
  ...
  },
  {
    ...
    docs: 'https://bun.com/blog/bun-v1.3.12#faster-bun-glob-scan',
    severity: 'info',
    fixTier: 'easy',
    eslintRules: [],
    modules: [],
  ...
  },
  {
    ...
    docs: 'https://bun.com/blog/bun-v1.3.12#faster-bun-stripansi-and-bun-stringwidth',
    severity: 'warn',
    fixTier: 'easy',
    eslintRules: [],
  ...
  },
  {
    ...
    docs: 'https://bun.com/docs/runtime/utils#bun-hash',
    severity: 'warn',
    fixTier: 'hard',
  ...
  },
  {
    ...
    docs: 'https://bun.com/docs/runtime/web-crypto',
    severity: 'info',
    fixTier: 'hard',
    eslintRules: [],
    modules: ['crypto', 'node:crypto'],
  ...
  },
  {
    ...
    docs: 'https://bun.com/blog/bun-v1.3.12#urlpattern-is-up-to-2-3x-faster',
    severity: 'info',
    fixTier: 'medium',
    eslintRules: [],
    modules: [],
