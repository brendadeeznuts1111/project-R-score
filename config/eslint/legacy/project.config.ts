...
/** Project-specific ESLint config blocks to spread into config/eslint/legacy/full-project.config.ts */
export const projectEslintConfig: Linter.Config[] = [
  ...
  },
  {
    ...
    files: ['lib/ai/ai-operations-manager.ts', 'lib/ai/anomaly-detector.ts'],
    rules: {
      'import/order': 'error',
