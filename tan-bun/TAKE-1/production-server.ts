 ...
 * - Memory-efficient response generation with ETag support
 * - Optional Gzip compression for eligible assets
...
async function initializeServer() {
  ...
  try {
    const serverModule = (await import('./.output/server/index.mjs')) as any
