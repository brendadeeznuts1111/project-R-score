...
import { factorywagerSecretsLifecycle } from './lib/config/factorywager-secrets-lifecycle.ts';

async function debugConfig() {
  try {
    console.log('Loading config...');
    const config = await factorywagerSecretsLifecycle.loadConfig('factorywager-secrets-lifecycle.yaml');
