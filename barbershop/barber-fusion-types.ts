...
export const BarberActions: Record<string, BarberActionProperties> = {
  ...
  ask_for_review: {
    ...
    script: "Thanks for visiting! If you enjoyed your cut, would you mind leaving a quick review? [Link]",
  ...
  offer_referral_bonus: {
    ...
    timing: 'post_service',
    durationSeconds: 20,
    script: "If you know anyone who needs a good cut, send them my way! You both get $10 off your next visit.",
  ...
  welcome_message: {
    ...
    timing: 'follow_up',
    durationSeconds: 0, // Automated
    script: "Welcome to [Barbershop]! Thanks for trusting us with your first cut. How did everything look?",
  ...
  set_spending_limit: {
    ...
    timing: 'at_checkout',
    durationSeconds: 15,
    script: "Just so you know, CashApp sometimes holds larger payments from new accounts. Want to split this into two?",
...
export const FusionImpactConfigs: Record<FusionTier, FusionImpactProperties> = {
  ...
  whale: {
    ...
    commission: {
      ...
      upsellBonus: 0.20,
      referralBonus: 50,
      productCommission: 0.30
    },
    qualification: {
      minVisits: 25,
      minSpend: 2000,
      maxDaysBetween: 7,
      requiredBehaviors: ['Books multiple slots', 'High tips', 'Refers others', 'Business/family account']
    }
  }
};
...
export const ActionMatrix: Record<AccountAgeTier, Record<FusionTier, string[]>> = {
  new: {
    casual: ['verify_new_account', 'welcome_message', 'book_next_appointment', 'set_spending_limit'],
  ...
  established: {
    ...
    active: ['book_next_appointment', 'suggest_products', 'offer_referral_bonus'],
    high_volume: ['book_next_appointment', 'suggest_products', 'offer_referral_bonus', 'ask_for_review'],
...
// Export all
export type { AccountAgeTier, AccountAgeProperties, ActionPriority, ActionCategory, ActionTiming, BarberActionProperties, FusionTier, ImpactLevel, FusionImpactProperties };
